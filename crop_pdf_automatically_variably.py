...
#Extracts the bounding box of the main text on the page, excluding headers, footers, and footnotes, and adds a margin around the text.
...
if __name__ == "__main__":
    pdf_path = input("Input file (or default to 'input.pdf': ") or 'input.pdf'
